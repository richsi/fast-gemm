...
def benchmark_naive_layer():
  ...
  # profile cuda
  ms_cuda = triton.testing.do_bench(lambda: fast_gemm.matmul_naive(A, B))
  ...
  print(f"Level 01 (Naive) : {ms_cuda:8.3f} ms | {tflops_cuda:6.2f} TFLOP/s")
  print("-"*45)
  print(f"Performance Gap  : Naive is running at {((tflops_cuda / tflops_torch) * 100):.2f}% of cuBLAS speed.")
  print("="*45)

if __name__ == "__main__":
  benchmark_naive_layer()